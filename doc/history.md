...
Back in late 2019, we at \*.ZK.\* (Zombie Knights, a gaming community that shaped itself within the zombie server scene, starting in 2010) ran into some rcon-related limitations with the libcod implementations available at that time. Therefore we decided to take a closer look at the inner workings of that extension (specifically, damage99's version listed above).
